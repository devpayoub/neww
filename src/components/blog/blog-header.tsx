  ...
  return (
    <section className="relative bg-gradient-to-br from-[#1D1046] to-[#3a1d8a] py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-96 h-96 rounded-full bg-blue-500/10 -top-20 -left-20 animate-pulse-soft"></div>
        <div
          className="absolute w-64 h-64 rounded-full bg-purple-500/10 bottom-10 right-10 animate-pulse-soft"
